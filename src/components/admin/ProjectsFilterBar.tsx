// components/admin/ProjectsFilterBar.tsx
"use client";
...
const FEATURED_OPTIONS = [
    ...
    { value: "not-featured", label: "Tidak Featured" },
];
...
export default function ProjectsFilterBar() {
    ...
    const hasActiveFilters = Boolean(searchParams.get("q")) || featured !== "all";
    ...
    return (
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <select
                value={featured}
                onChange={(e) =>
                    updateParams({ featured: e.target.value === "all" ? null : e.target.value })
                }
